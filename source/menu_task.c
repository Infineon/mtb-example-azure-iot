...
*
* Description: This file contains tasks and functions related to Azure task
* creation and Wi-Fi initialization.
*
********************************************************************************
...
void menu_task(void *arg)
{
    ...
    while(!valid_option)
    {
        ...
        switch(uart_read_integer)
        {
            case CLOUD_2_DEVICE:
            {
                printf("\r\nCloud_to_device messaging feature demo begins\r\n\n");
                xTaskCreate(Azure_hub_c2d_app, "Azure_hub_c2d_app", AZURE_TASK_STACK_C2D, NULL, AZURE_TASK_PRIORITY_C2D, NULL);
                valid_option = true;
                break;
            }
            ...
            case TELEMETRY:
            {
                printf("\r\nDevice Telemetry feature demo begins\r\n\n");
                xTaskCreate(Azure_hub_telemetry_app, "Azure_hub_telemetry_app", AZURE_TASK_STACK_TELEMETRY, NULL, AZURE_TASK_PRIORITY_TELEMETRY, NULL);
                valid_option = true;
                break;
            }
            ...
            case METHODS:
            {
                printf("\r\nMethods feature demo begins\r\n\n");
                xTaskCreate(Azure_hub_method_app, "Azure_hub_method_app", AZURE_TASK_STACK_METHODS, NULL, AZURE_TASK_PRIORITY_METHODS, NULL);
                valid_option = true;
                break;
            }
            ...
            case TWIN:
            {
                printf("\r\nDevice Twin feature demo begins\r\n\n");
                xTaskCreate(Azure_hub_twin_app, "Azure_hub_twin_app", AZURE_TASK_STACK_TWIN, NULL, AZURE_TASK_PRIORITY_TWIN, NULL);
                valid_option = true;
                break;
            }
            ...
            {
                printf("\r\nDevice Provisioning feature demo begins\r\n\n");
                xTaskCreate(azure_dps_app_task, "MQTT_DPS", AZURE_TASK_STACK_AZURE_DPS, NULL, AZURE_TASK_PRIORITY_AZURE_DPS, NULL);
                valid_option = true;
                break;
            }
            ...
            case PLUG_N_PLAY:
            {
                ...
                xTaskCreate(Azure_hub_pnp_app, "Azure_hub_pnp_app", AZURE_TASK_STACK_PNP, NULL, AZURE_TASK_PRIORITY_PNP, NULL);
                valid_option = true;
                break;
            }
