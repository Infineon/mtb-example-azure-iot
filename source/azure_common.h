...
"\r\n"                                                                          \
"\r1. C2D (Cloud to Device messaging)\r\n\n"                                    \
"2. Telemetry\r\n\n"                                                            \
"3. Methods\r\n\n"                                                              \
"4. Twin\r\n\n"                                                                 \
"5. Azure Device Provisioning Service\r\n\n"                                    \
"6. PnP (Plug and Play)\r\n\n"                                                  \
...
#define AZURE_TASK_STACK_C2D            (1024 * 10)
#define AZURE_TASK_STACK_TELEMETRY      (1024 * 10)
...
#define AZURE_TASK_PRIORITY_C2D         (5)
#define AZURE_TASK_PRIORITY_TELEMETRY   (5)
...
typedef enum
{
    ...
    METHODS,
    TWIN,
    AZURE_DEVICE_PROVISIONING_SERVICE,
    PLUG_N_PLAY
} azure_features_t;
